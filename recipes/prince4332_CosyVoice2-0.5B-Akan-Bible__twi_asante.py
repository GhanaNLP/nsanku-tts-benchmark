"""Evaluation recipe for prince4332/CosyVoice2-0.5B-Akan-Bible — Asante Twi (twi_asante).

Architecture: CosyVoice2 (0.5B)
...
CosyVoice2 is zero-shot: it copies the voice of a reference clip.
...
REFERENCE_TEXT = 'Atoyerɛnkyɛm asi wɔ bea a wɔgu fangoo ɛgu ɛhyɛn mu.'
SPEED = 1.0
