"""Evaluation recipe for Google/gemini-3.1-flash-tts-preview — Dagaare (dga).

Architecture: Google Gemini 3.1 Flash TTS (API)
...
https://github.com/GhanaNLP/nsanku-tts-benchmark to change how Dagaare is
